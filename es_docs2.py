...
def process_data(
    ...
    with open("config/create_index.json", "r") as create_file:
        es_create_settings = json.load(create_file)
...
if __name__ == "__main__":
    ...
    """
    d --memory=7500m --memory-swap=12000m -p 9090:8000 --net=host -e ildb_host=10.50.98.102 -e ildb_user=digirati -e ildb_password=jaffaCAKES9 -e es_host=vpc-dev-elasticsearch-6njgchnnn3kml3qbyhrp52g37m.eu-west-2.es.amazonaws.com -e flask_local=True -e es_resolver_index=path-resolver-mongo -e es_update=False -e ildb_port=1433 -e es_port=443 alphaingest
    ...
    print(f"Index: {es_resolver_index}")
